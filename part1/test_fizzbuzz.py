...
def test_fizzbuzz_multiple_of_three_should_return_fizz():
...
#Example Negative pytest throwing an TypeError
def test_negative_pytest_array_should_throw_type_error():
